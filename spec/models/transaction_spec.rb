...
RSpec.describe Transaction, type: :model do
  ...
  describe "doesn't save bad transactions," do
    ...
    it "doesn't save duplicate hash values" do
      tx_bad_dup = Transaction.new(txHash:transactions(:one).txHash, data: transactions(:one).data)
  ...
  describe "fixture" do
    ...
    it "provides the right data" do
      expect(transactions(:one).txHash).to eq('0x6f61ee4dc528443d8b6ab12240a53588fb72c659e1abfe6e6cc0d2346359be4a')
